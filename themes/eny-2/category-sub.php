...
<main class="container">
  ...
  <div class="row cat-archive flex-column-reverse flex-lg-row">
    ...
    <div class="col-lg-9">
      ...
      <?php if ($cg_tree[0]['cr'][0]['cr']) : ?>
      <section class="cat-archive__cats">
        <h1 class="cat-archive__cats__title">
          <?php echo $cg_tree[0]['cr'][0]['name']; ?>
        </h1>

        <ul class="cat-summary__cat__lists">
          <div>
            <?php foreach ($cg_tree[0]['cr'][0]['cr'] as $third) : ?>
            <li>
              <a class="link" href="<?php echo $home_url . '/categories/' . $third['id'] ?>">
                <?php
                $item = $third;
      ...
      <section class="cat-archive__articles">
        ...
        <h1 class="cat-archive__articles__title">
          <?php echo $cg_tree[0]['cr'][0]['name']; ?>の商品一覧
          <span>
            <?php echo "(" . $count . "件)"; ?>
          </span>
        </h1>
        ...
        <a class="cat-archive__articles__button" href="<?php echo $home_url . '/categories/' . $cg_tree[0]['cr'][0]['id'] . '/products/' ?>">
      ...
      <section class="cat-archive__articles">
        <?php if (have_posts()) : ?>
        <h1 class="cat-archive__articles__title">
          <?php echo $cg_tree[0]['cr'][0]['name']; ?>の記事一覧
          <span>
        ...
        <a class="cat-archive__articles__button" href="<?php echo $home_url . '/categories/' . $cg_tree[0]['cr'][0]['id'] . '/articles' ?>">
          <button class="button button--solid" type="button">
            <p>もっと見る</p>
          </button>
        </a>
